...
VALUES ('C001', 'Aula Magna', '9:00-11:00', 6);

INSERT INTO Corso (ID_Corso, Luogo, Orari, Crediti)
VALUES ('C002', 'Laboratorio Informatica', '14:00-16:00', 8);

INSERT INTO Corso (ID_Corso, Luogo, Orari, Crediti)
VALUES ('C003', 'Aula 101', '11:00-13:00', 4);

INSERT INTO Corso (ID_Corso, Luogo, Orari, Crediti)
VALUES ('C004', 'Aula Video', '16:00-18:00', 6);

INSERT INTO Corso (ID_Corso, Luogo, Orari, Crediti)
VALUES ('C005', 'Biblioteca', '10:00-12:00', 5);


-- Creazione della tabella LAUREA
CREATE TABLE Laurea (
     ID_Laurea VARCHAR2 NOT NULL,
     Facolta VARCHAR2 (50),
     Anni Number,
...
CREATE TABLE Frequenza (
     ID_Frequenza VARCHAR2 NOT NULL,
...
--insert
INSERT INTO Consegue (ID_Consegue, ID_Studente, ID_Laurea, Data_Conseguemento)
VALUES ('CG001', 'S001', 'L001', TO_DATE('2023-07-15', 'YYYY-MM-DD'));

INSERT INTO Consegue (ID_Consegue, ID_Studente, ID_Laurea, Data_Conseguemento)
VALUES ('CG002', 'S002', 'L002', TO_DATE('2023-07-20', 'YYYY-MM-DD'));

INSERT INTO Consegue (ID_Consegue, ID_Studente, ID_Laurea, Data_Conseguemento)
VALUES ('CG003', 'S003', 'L003', TO_DATE('2023-07-25', 'YYYY-MM-DD'));

INSERT INTO Consegue (ID_Consegue, ID_Studente, ID_Laurea, Data_Conseguemento)
VALUES ('CG004', 'S004', 'L004', TO_DATE('2023-07-30', 'YYYY-MM-DD'));

INSERT INTO Consegue (ID_Consegue, ID_Studente, ID_Laurea, Data_Conseguemento)
VALUES ('CG005', 'S005', 'L005', TO_DATE('2023-08-05', 'YYYY-MM-DD'));

-- Creazione della tabella MATERIA 
CREATE TABLE MATERIA (
   ID_Materia VARCHAR2 NOT NULL,
   ID_Laurea  VARCHAR2 (20),
   ID_Corso VARCHAR2 (20),
